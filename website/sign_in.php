...
<div class="wrapper">
	...
	<div class="main-body">
		...
		<h2 class="form title">Members Sign in</h2>
		<h3 class="form title">Please fill in the below fields:</h3>
		<p>
	
		    <label class="form" for="email">Email address:</label><br />
			<input name="email" id="email" type="text" /><br />
			
			<label class="form" for="pword">Password:</label><br />
...
include('db_conn.php'); //db connection
	...
	if(isset($_POST['submit']))
	{
	  ...
	  $encrypt_password=MD5($password);
		...
		$query = "SELECT `Name`,`ID`,`Access` FROM `Customers` WHERE (`email` = '$email' && `password` = '$encrypt_password')";
			...
			*/	
				header('location: ./confirm-in.php');
			}
	      else {
